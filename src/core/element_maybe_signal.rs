...
//     ($ty:ty) => {
//         impl<E, At, Ch> From<HtmlElement<E, At, Ch, Dom>> for ElementMaybeSignal<$ty, $ty>
//         where
//             E: ElementType,
//             E: CreateElement<Dom>,
//         {
//             fn from(value: HtmlElement<E, At, Ch, Dom>) -> Self {
//                 let el: &$ty = value.create_element().deref();
...
//     ($signal:ty, $ty:ty) => {
//         impl<E, At, Ch, Rndr> From<$signal> for ElementMaybeSignal<$ty, $ty>
//         where
//             E: ElementType,
//             E::Output: std::ops::Deref<Target = $ty> + Clone,
//         {
...
// }
//
// impl_from_signal_html_element!(Signal<HtmlElement<E, At, Ch, Rndr>>, web_sys::EventTarget);
// impl_from_signal_html_element!(
//     ReadSignal<HtmlElement<E, At, Ch, Rndr>>,
//     web_sys::EventTarget
// );
// impl_from_signal_html_element!(RwSignal<HtmlElement<E, At, Ch, Rndr>>, web_sys::EventTarget);
// impl_from_signal_html_element!(Memo<HtmlElement<E, At, Ch, Rndr>>, web_sys::EventTarget);
//
// impl_from_signal_html_element!(Signal<HtmlElement<E, At, Ch, Rndr>>, web_sys::Element);
// impl_from_signal_html_element!(ReadSignal<HtmlElement<E, At, Ch, Rndr>>, web_sys::Element);
// impl_from_signal_html_element!(RwSignal<HtmlElement<E, At, Ch, Rndr>>, web_sys::Element);
// impl_from_signal_html_element!(Memo<HtmlElement<E, At, Ch, Rndr>>, web_sys::Element);
//
...
//
// impl_from_signal_html_element!(
//     Signal<Option<HtmlElement<E, At, Ch, Rndr>>>,
//     web_sys::EventTarget
// );
// impl_from_signal_html_element!(
//     ReadSignal<Option<HtmlElement<E, At, Ch, Rndr>>>,
//     web_sys::EventTarget
// );
// impl_from_signal_html_element!(
//     RwSignal<Option<HtmlElement<E, At, Ch, Rndr>>>,
//     web_sys::EventTarget
// );
// impl_from_signal_html_element!(
//     Memo<Option<HtmlElement<E, At, Ch, Rndr>>>,
//     web_sys::EventTarget
// );
//
// impl_from_signal_html_element!(
...
//     web_sys::Element
// );
// impl_from_signal_html_element!(Memo<Option<HtmlElement<E, At, Ch, Rndr>>>, web_sys::Element);
